...
wget -O templates.tpz https://github.com/godotengine/godot/releases/download/4.7.2-stable/Godot_v4.7.2-stable_export_templates.tpz
...
cd ~/.local/share/godot/export_templates/4.7.2.stable/
